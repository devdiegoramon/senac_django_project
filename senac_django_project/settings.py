TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Permite a busca em 'templates' dentro de cada app
        'OPTIONS': {
            'context_processors': [
...
SECRET_KEY = 'django-insecure-ligc=s16#4g=6u5qbnx1rqc@pz*4oj1*in4aa3@o67g6(gg)o7'
...
# senac_django_project/settings.py
...
INSTALLED_APPS = [
    ...
    'contas',  # Verifique se 'contas' está aqui
    'core',  # Outro app do seu projeto
]
